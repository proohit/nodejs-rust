...
Registry.fromConnectionString(hubDevicesConnectionString)
  .createQuery("SELECT * FROM devices")
  .nextAsTwin(onDevicesQuery);
...
serviceClient.open(function (err) {
  if (err) {
    ...
    var message = new Message(
      '{"action":"update","version":"0.0.1","url":"https://github.com/proohit/nodejs-rust/releases/download","runtimes":["js"]}'
    );
    message.ack = "full";
